...
var
  i: integer;
begin
  MyIni := getParentFolderDir + 'Metabrain Database 2.1\metaservice.ini';
  ...
  begin
    ...
    if AnsiPos('basedir',ConfigIni.Strings[i]) > 0 then
      ConfigIni.Strings[i] := 'basedir="' + AnsiReplaceText(getParentFolderDir,'\','/') + 'Metabrain Database 2.1/database"';
    if AnsiPos('datadir',ConfigIni.Strings[i]) > 0 then
      ConfigIni.Strings[i] := 'datadir="' + AnsiReplaceText(getParentFolderDir,'\','/') + 'Metabrain Database 2.1/database/data"';
  end;
...
begin
    ...
    ShellExecute(Handle,'open',PChar(getParentFolderDir + 'Metabrain Database 2.1\database\bin\mysqld.exe'),PChar('--install MetaService --defaults-file="' + getParentFolderDir + 'Metabrain Database 2.1\metaservice.ini'),PChar(getParentFolderDir + 'Metabrain Database 2.1\database\bin'),SW_HIDE);
    Sleep(3000);
    StartMetaService;
end;
...
begin
   ...
   ShellExecute(Handle,'open',PChar(getParentFolderDir + 'Metabrain Database 2.1\database\bin\mysqld.exe'),'--remove MetaService',PChar(getParentFolderDir + 'Metabrain Database 2.1\database\bin'),SW_HIDE);
end;
