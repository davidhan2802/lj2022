object frmSellOrder: TfrmSellOrder
  Left = 172
  Top = 95
  BorderStyle = bsNone
  Caption = 'frmSellOrder'
  ClientHeight = 558
  ClientWidth = 1081
  Color = clBtnFace
  ...
  object PanelSell: TRzPanel
    ...
    object PenjualanDBGrid: TRzDBGrid
      ...
      DataSource = DataModule1.DSFormSellOrder
      DefaultDrawing = True
      FixedColor = 8454143
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
    ...
    object RzPanel4: TRzPanel
      ...
      object SellTxtPPN: TRzNumericEdit
        ...
        ReadOnly = True
        TabOrder = 1
        OnChange = SellTxtPPNChange
        DisplayFormat = ',0;(,0)'
      end
      object SellTxtTotal: TRzNumericEdit
        Left = 104
        Top = 53
        Width = 201
        Height = 25
      ...
      object SellTxtDisc: TRzNumericEdit
        Left = 104
        Top = 77
        Width = 42
        Height = 25
    ...
    object RzPanel5: TRzPanel
      ...
      object SellTxtKembali: TRzNumericEdit
        Left = 8
        Top = 62
        Width = 217
        Height = 26
      ...
      object SellTxtDibayar: TRzNumericEdit
        Left = 8
        Top = 20
        Width = 217
        Height = 26
    ...
    object RzPanel7: TRzPanel
      ...
      object SellTxtCustomer: TRzEdit
        Left = 88
        Top = 6
        Width = 257
        Height = 24
  ...
  object SellPanelCredit: TRzPanel
    ...
    object SellLblNoCredit: TRzLabel
      Left = 6
      Top = 9
      Width = 64
      Height = 16
    ...
    object SellTxtTempo: TRzDateTimeEdit
      Left = 319
      Top = 6
      Width = 147
      Height = 24
      ...
      ParentFont = False
      TabOrder = 0
      OnChange = SellTxtTempoChange
      OnKeyDown = PenjualanDBGridKeyDown
    end
    object SellTxtNoCredit: TRzEdit
      Left = 80
      Top = 6
      Width = 144
      Height = 24
