...
begin
 ...
 begin
  ...
  begin
    ...
    DataModule1.ZQryFormSellOrder.first;
    vnourut := 1;
    while not DataModule1.ZQryFormSellOrder.Eof do
    begin
     DataModule1.ZQryFormSellOrder.Edit;
     DataModule1.ZQryFormSellOrdernomordet.Value := vnourut;
     DataModule1.ZQryFormSellOrder.Post;

     vnourut := vnourut + 1;

     DataModule1.ZQryFormSellOrder.Next;
    end;
    CalculateGridSell;
  end;
end;
