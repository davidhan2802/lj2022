...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('update sales set ');
    SQL.Add('kode = ' + QuotedStr(SalesTxtKode.Text) + ',');
    ...
    SQL.Add('where idsales = ' + QuotedStr(DataModule1.ZQrySalesidsales.AsString) );
    ExecSQL;
  end;
end;
...
begin
  ...
  begin
    ...
    Close;
    SQL.Clear;
    SQL.Add('select idsales from Sales');
