  ...
  begin
    ...
    begin
      ...
      begin
        ...
        SQL.Add('where s.faktur = j.fakturjual and j.faktur=' + Quotedstr(DataModule1.ZQryReturJualfaktur.AsString) );
        ExecSQL;
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('select r.*,c.nama namacust,c.alamat alamatcust,c.npwp npwpcust from returjualmaster r ');
    SQL.Add('left join customer c on r.kodecustomer=c.kode ');
  ...
  DataModule1.ZQryReturJualdet.Close;
  DataModule1.ZQryReturJualdet.Open;
