...
begin
  ...
  begin
    ...
    SQL.Add('(idReturJual,faktur,kode,nama,kategori,merk,seri,tipe,keterangan,qtyjual,qtyretur,hargabeli,hargajual,diskon,diskon2,diskon_rp,diskonrp,satuan,fakturjual,kodegudang,subtotal)');
    SQL.Add('select '+Quotedstr(idTrans)+',faktur,kode,nama,kategori,merk,seri,tipe,keterangan,quantity,quantityretur,hargabeli,harga,diskon,diskon2,diskon_rp,diskonrp,satuan,fakturjual,kodegudang,subtotal ');
...
//    SQL.Add('pembayaran = "' + RtrTxtPembayaran.Text + '",');
    ...
    SQL.Clear;
    SQL.Add('insert into returjualdetail');
    SQL.Add('(faktur,kode,nama,kategori,merk,seri,tipe,keterangan,qtyjual,qtyretur,hargajual,diskon,diskon2,diskonrp,satuan,fakturjual,kodegudang,hargabeli)');
    SQL.Add('select faktur,kode,nama,kategori,merk,seri,tipe,keterangan,quantity,quantityretur,harga,diskon,diskon2,diskonrp,satuan,fakturjual,kodegudang,hargabeli ');
...
begin
  ...
  begin
    ...
    begin
      ...
      SQL.Add('kategori,merk,seri,tipe,faktur,diskon,diskon2,diskonrp,fakturjual,kodegudang,hargabeli from returjualdetail');
